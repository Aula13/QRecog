...
main (int argc, char** argv)
{
  ...
  if (pcl::console::find_argument (argc, argv, "-f") >= 0)
  {
    ...
    file = true;
    filename_ = argv[filenames[0]];
    std::cout << "Exctract pointcloud from file\n";
  ...
  if (file)
  {
    if (pcl::io::loadPCDFile<pcl::PointXYZRGB> (filename_, *point_cloud_ptr) == -1) //* load the file
    {
