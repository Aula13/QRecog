...
showHelp (char *filename)
{
  ...
  std::cout << "     --scene_ss val:         Scene uniform sampling radius (default 0.01)" << std::endl;
...
//    pcl::transformPointCloud (*model, *model, t);
  ...
  std::cout << "Scene total points: " << scene->size () << "\nModel Selected Keypoints: " << scene_keypoints->size () << std::endl;
